...
### **Modern Data Pipeline with dbt, Airflow & Redshift**
Built production-ready ELT processes, implemented version-controlled data models, and improved data reliability and refresh efficiency.

### **KPI and Product Insights Platform (BigQuery + Metabase)**
Designed analytical queries and dashboards to surface core KPIs, enabling clearer visibility for cross-functional teams.
